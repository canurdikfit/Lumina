...
import BannerImg from "./../assets/imgs/banner_background.png";
    ...
    <section className="relative w-screen min-h-[600px] md:min-h-[650px] xl:min-h-[850px] bg-white flex items-end justify-center ">
      ...
      <div className="relative z-20 flex flex-col items-center justify-center">
        <div className="flex flex-col items-center justify-center gap-5 md:gap-7 xl:gap-10">
          ...
          <button
            id="button"
            className="bg-none outline-none border-none max-w-[140px] md:max-w-[150px] xl:max-w-[240px] shrink-0 btnHov"
          >
            <img
              src={JoinButton}
              alt="Join Waitlist"
